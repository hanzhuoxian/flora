...
// WarnWordSepNormalizeFunc It is a function that converts flag names from underline format
// to hyphen format and issues a deprecation warning during the conversion.
